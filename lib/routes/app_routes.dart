...
import 'package:flutter_intermediate/sections/section_6/passing_variables.dart';
import 'package:flutter_intermediate/sections/section_6/section_6.dart';
import 'package:flutter_intermediate/sections/section_6/widgets/global_state_widget.dart';
import 'package:flutter_intermediate/sections/section_6/widgets/passing_variables_widget.dart';
import 'package:flutter_intermediate/sections/section_6/widgets/redux_widget.dart';
...
static Map<String, WidgetBuilder> get routes => {
    ...
    routePaths["section5"]!: (BuildContext context) => Section5(),
    ...
    routePaths["section6"]!: (BuildContext context) => Section6(),
    routePaths["global_state_screen"]!: (BuildContext context) => GlobalStateScreen(),
    routePaths["passing_variables"]!: (BuildContext context) => PassingVariables(),
    routePaths["redux"]!: (BuildContext context) => PushPop(),
    routePaths["global_state_widget"]!: (BuildContext context) => GlobalStateWidget(),
    // routePaths["passing_variable_widget"]!: (BuildContext context) => PassingVariablesWidget(), //Necessário passagem do estado neste exemplo -> MaterialPageRoute
    routePaths["redux_widget"]!: (BuildContext context) => ReduxWidget(),
};

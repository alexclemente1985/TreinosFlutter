...
import 'package:listins/products/data/products_box_handler.dart';
import 'package:listins/products/helpers/enum_order.dart';
import 'package:listins/products/screens/widgets/product_add_edit_modal.dart';
...
class _ProductsScreenState extends State<ProductsScreen> {
  ...
  void initState() {
    ...
    _productsBoxHandler.openBox(widget.listin.id).then((_) => refresh());
    super.initState();
  }
  ...
  _removeProduct(Product produto) async {
    ...
    _productsBoxHandler.deleteProduct(produto);
    refresh();
  }

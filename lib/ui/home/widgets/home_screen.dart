...
import 'package:memorando/ui/home/widgets/header_widget.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  Future<void> showTaskModal({
    ...
    required void Function(String title, String description, String category, String priority, String responsible)
        onSubmit,
  }) async {
    ...
    final TextEditingController responsibleController =
        TextEditingController(text: existingTask?.responsible ?? '');
          ...
          SliverToBoxAdapter(
            child: AddTaskButton(
              onPressed: () {
                showTaskModal(
                  context: context,
                  onSubmit: (title, description, category, priority, responsible) {
                    taskViewModel.addTask(title, description, category, priority, responsible);
                  },
                );
              },
            ),
...
//                   child: Text(
//                     'Finalizadas', 
//                     style: TextStyle(color: filterIsCompleted == true ? Colors.amber : Colors.black),
//                   )
//                 ),
//                 TextButton(
//                   onPressed: (){
...
//                   child: Text(
//                     'Não Finalizadas',
//                     style: TextStyle(color: filterIsCompleted == false ? Colors.amber : Colors.black),
//                   )
//                 ),
//               ],
//             ),
...
//                             isCompleted: task.isCompleted,
//                           );
//                           taskViewModel.updateTask(updatedTask, filterIsCompleted);
//                         },
//                       );
//                     },
//                     onDelete: () => taskViewModel.deleteTask(task.id!),

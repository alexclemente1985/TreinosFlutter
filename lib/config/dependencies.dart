...
import 'package:runner_circle/data/storage/local_secure_storage.dart';
import 'package:runner_circle/data/storage/local_storage.dart';
import 'package:runner_circle/data/storage/shared_preferences_storage.dart';
...
List<SingleChildWidget> get providersLocal {
  return [
    ...
    ChangeNotifierProvider<ThemeManager>(
      create: (context) => ThemeManager(localStorage: context.read<LocalStorage>())
    ),
    Provider<AuthRepository>(
      create: (context) => MockAuthRepository(localStorage: LocalSecureStorage()),
    ),
